...
var stringify$4 = (ast, options = {}) => {
  const stringify = (node, parent = {}) => {
    const invalidBlock = options.escapeInvalid && utils$f.isInvalidBrace(parent);
...
const compile$1 = (ast, options = {}) => {
  const walk = (node, parent = {}) => {
    const invalidBlock = utils$e.isInvalidBrace(parent);
    const invalidNode = node.invalid === true && options.escapeInvalid === true;
    ...
    if (node.nodes && node.ranges > 0) {
      const args = utils$e.reduce(node.nodes);
...
const expand$1 = (ast, options = {}) => {
  ...
  const walk = (node, parent = {}) => {
    ...
    const enclose = utils$d.encloseBrace(node);
...
const _page0 = () => import('./chunks/generic_BkohZbar.mjs');
const _page1 = () => import('./chunks/404_B4VXIk0w.mjs');
const _page2 = () => import('./chunks/index_Bhp9ZreG.mjs');
const pageMap = new Map([
    ["node_modules/.pnpm/astro@4.10.0/node_modules/astro/dist/assets/endpoint/generic.js", _page0],
...
const _args = {
    "middlewareSecret": "f81147fd-1430-4dd1-a0f0-e94582ee293d",
