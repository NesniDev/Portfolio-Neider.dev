/* empty css                          */
import { c as createAstro, d as createComponent, r as renderTemplate, m as maybeRenderHead, s as spreadAttributes, f as renderComponent, e as addAttribute, h as renderSlot, g as renderHead, F as Fragment } from '../astro_ChJLnC3Y.mjs';
import { $ as $$ViewTransitions } from './404_Cr6rZfMG.mjs';
/* empty css                          */
...
const $$Whtasapp = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$M, $$props, $$slots);
  Astro2.self = $$Whtasapp;
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/Social/Whtasapp.astro", void 0);
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/Social/Facebook.astro", void 0);
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/Social/Instagram.astro", void 0);

const $$Astro$J = createAstro();
const $$Twitter = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$J, $$props, $$slots);
  Astro2.self = $$Twitter;
  return renderTemplate`${maybeRenderHead()}<svg${spreadAttributes(Astro2.props)} version="1.0" xmlns="http://www.w3.org/2000/svg" width="512.000000pt" height="512.000000pt" viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet"> <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none"> <path d="M412 5100 c-97 -26 -173 -70 -248 -144 -75 -76 -119 -151 -144 -252
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/Social/Linkedin.astro", void 0);
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/Social/Gmail.astro", void 0);

const $$Astro$F = createAstro();
const $$Footer = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$F, $$props, $$slots);
  Astro2.self = $$Footer;
  return renderTemplate`${maybeRenderHead()}<footer class="flex flex-col text-lg w-full mx-auto max-w-[1000px] mb-1 overflow-hidden dark:text-[#012029] text-[#D3D3D3]"> <div class="flex flex-col md:flex-row gap-10 justify-between"> <div class="flex flex-col text-center"> <h2 class="text-[var(--orange)] text-4xl mb-8 font-extrabold">
Contactáme
</h2> <p class="font-extralight">Centro de Chiquinquirá - Boyacá, Colombia</p> <p class="font-extralight">(+57) 313 240 5135</p> </div> <div class="flex flex-row flex-wrap px-6 justify-center gap-10 text-center"> <div class="flex flex-col"> <a class="text-lg font-extrabold mb-5 text-white dark:text-[#012029]" href="/#experiencia">Experiencia</a> <ul class="list-footer font-extralight"> <li>Docente informática</li> <li>Técnico en Sistemas</li> <li>Asesor de ventas</li> </ul> </div> <div class="flex flex-col"> <a class="text-lg font-extrabold mb-5 text-white dark:text-[#012029]" href="/#habilidades">Herramientas</a> <ul class="list-footer font-extralight"> <li>Astro</li> <li>CSS</li> <li>JavaScript</li> </ul> </div> <div class="flex flex-col"> <a class="text-lg font-extrabold mb-5 text-white dark:text-[#012029]" href="#">Estudios</a> <ul class="list-footer font-extralight"> <li>Técnico</li> <li>Ingeniería</li> <li>Especialización</li> </ul> </div> </div> </div> <div class="flex flex-wrap gap-7 md:gap-10 justify-center items-center mt-10"> <a href="https://wa.me/573132405135" class="p-2 bg-yellow-500 rounded-full hover:bg-slate-200 transition delay-150 ease-in"> ${renderComponent($$result, "Whatsapp", $$Whtasapp, { "class": "size-7" })} </a> <a href="https://www.facebook.com/neider.stith/" class="p-2 bg-yellow-500 rounded-full hover:bg-slate-200 transition delay-150 ease-in"> ${renderComponent($$result, "Facebook", $$Facebook, { "class": "size-7" })} </a> <a href="https://www.linkedin.com/in/neidernieto/" class="p-2 bg-yellow-500 rounded-full hover:bg-slate-200 transition delay-150 ease-in"> ${renderComponent($$result, "Linkedin", $$Linkedin, { "class": "size-7" })} </a> <a href="https://www.instagram.com/neider_niet0/" class="p-2 bg-yellow-500 rounded-full hover:bg-slate-200 transition delay-150 ease-in"> ${renderComponent($$result, "Instagram", $$Instagram, { "class": "size-8" })} </a> <a href="https://twitter.com/NeiderNieto10" class="p-2 bg-yellow-500 rounded-full hover:bg-slate-200 transition delay-150 ease-in"> ${renderComponent($$result, "Twitter", $$Twitter, { "class": "size-7" })} </a> <a href="https://github.com/NesniDev" class="p-2 bg-yellow-500 rounded-full hover:bg-slate-200 transition delay-150 ease-in"> ${renderComponent($$result, "GitHub", $$GitHub$1, { "class": "size-7" })} </a> <a href="mailto:nestnidev17@gmail.com" class="p-2 bg-yellow-500 rounded-full hover:bg-slate-200 transition delay-150 ease-in"> ${renderComponent($$result, "Gmail", $$Gmail, { "class": "size-7" })} </a> </div> <p class="text-center mt-7">
Hecho con Astro 🪐🧑‍🚀. Gracias por ver mi portfolio ❤️👨‍💻.
</p> </footer>`;
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/components/Footer.astro", void 0);

const $$Astro$E = createAstro();
const $$Sun = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$E, $$props, $$slots);
  Astro2.self = $$Sun;
  return renderTemplate`${maybeRenderHead()}<svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"${addAttribute(Astro2.props.class, "class")}><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fill-rule="evenodd" clip-rule="evenodd" d="M4.25 19C4.25 18.5858 4.58579 18.25 5 18.25H19C19.4142 18.25 19.75 18.5858 19.75 19C19.75 19.4142 19.4142 19.75 19 19.75H5C4.58579 19.75 4.25 19.4142 4.25 19ZM7.25 22C7.25 21.5858 7.58579 21.25 8 21.25H16C16.4142 21.25 16.75 21.5858 16.75 22C16.75 22.4142 16.4142 22.75 16 22.75H8C7.58579 22.75 7.25 22.4142 7.25 22Z" fill="currentColor"></path> <path d="M6.08267 15.25C5.5521 14.2858 5.25 13.1778 5.25 12C5.25 8.27208 8.27208 5.25 12 5.25C15.7279 5.25 18.75 8.27208 18.75 12C18.75 13.1778 18.4479 14.2858 17.9173 15.25H22C22.4142 15.25 22.75 15.5858 22.75 16C22.75 16.4142 22.4142 16.75 22 16.75H2C1.58579 16.75 1.25 16.4142 1.25 16C1.25 15.5858 1.58579 15.25 2 15.25H6.08267Z" fill="currentColor"></path> <path fill-rule="evenodd" clip-rule="evenodd" d="M12 1.25C12.4142 1.25 12.75 1.58579 12.75 2V3C12.75 3.41421 12.4142 3.75 12 3.75C11.5858 3.75 11.25 3.41421 11.25 3V2C11.25 1.58579 11.5858 1.25 12 1.25ZM4.39861 4.39861C4.6915 4.10572 5.16638 4.10572 5.45927 4.39861L5.85211 4.79145C6.145 5.08434 6.145 5.55921 5.85211 5.85211C5.55921 6.145 5.08434 6.145 4.79145 5.85211L4.39861 5.45927C4.10572 5.16638 4.10572 4.6915 4.39861 4.39861ZM19.6011 4.39887C19.894 4.69176 19.894 5.16664 19.6011 5.45953L19.2083 5.85237C18.9154 6.14526 18.4405 6.14526 18.1476 5.85237C17.8547 5.55947 17.8547 5.0846 18.1476 4.79171L18.5405 4.39887C18.8334 4.10598 19.3082 4.10598 19.6011 4.39887ZM1.25 12C1.25 11.5858 1.58579 11.25 2 11.25H3C3.41421 11.25 3.75 11.5858 3.75 12C3.75 12.4142 3.41421 12.75 3 12.75H2C1.58579 12.75 1.25 12.4142 1.25 12ZM20.25 12C20.25 11.5858 20.5858 11.25 21 11.25H22C22.4142 11.25 22.75 11.5858 22.75 12C22.75 12.4142 22.4142 12.75 22 12.75H21C20.5858 12.75 20.25 12.4142 20.25 12Z" fill="currentColor"></path> </g></svg>`;
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/variable/Sun.astro", void 0);

const $$Astro$D = createAstro();
const $$Moon = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$D, $$props, $$slots);
  Astro2.self = $$Moon;
  return renderTemplate`${maybeRenderHead()}<svg width="48" height="48" fill="currentColor"${addAttribute(Astro2.props.class, "class")} viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <desc>Created with Sketch.</desc> <defs></defs> <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"> <g id="Dribbble-Light-Preview" transform="translate(-380.000000, -2559.000000)" fill="#808000"> <g id="icons" transform="translate(56.000000, 160.000000)"> <path d="M339.000414,2410.957 C338.983414,2410.957 338.966414,2410.959 338.950414,2410.962 C338.933414,2410.964 338.917414,2410.967 338.900414,2410.967 C337.867414,2405.843 330.638414,2405.555 329.218414,2410.614 L329.218414,2410.614 C328.952414,2411.561 328.888414,2412.25 329.237414,2413.397 C327.129414,2411.722 324.689414,2414.983 326.788414,2416.542 C327.162414,2416.82 327.632414,2417 328.117414,2417 L338.894414,2417 L338.913414,2417 L338.932414,2417 C340.024414,2417 341.427414,2416.229 341.845414,2414.926 C342.517414,2412.828 340.890414,2410.957 339.000414,2410.957 M337.294414,2405.797 C338.799414,2406.607 339.823414,2407.792 340.422414,2409.174 C340.425414,2409.179 340.428414,2409.183 340.432414,2409.186 C340.436414,2409.19 340.440414,2409.193 340.445414,2409.194 C340.986414,2409.358 341.487414,2409.611 341.933414,2409.934 C341.973414,2409.613 341.999414,2409.288 341.999414,2408.957 C341.999414,2405.9 340.274414,2403.241 337.748414,2401.894 C337.853414,2403.129 337.760414,2404.353 337.294414,2405.797 M343.549414,2411.905 C344.449414,2413.868 343.999414,2416.203 342.281414,2417.681 C341.335414,2418.494 340.088414,2419 338.770414,2419 L328.201414,2419 C327.179414,2419 326.203414,2418.618 325.450414,2418.004 C324.696414,2417.391 324.165414,2416.502 324.034414,2415.489 C323.898414,2414.436 324.173414,2413.454 324.719414,2412.675 C324.722414,2412.671 324.725414,2412.668 324.728414,2412.665 C324.369414,2411.766 324.133414,2410.872 324.043414,2409.811 C325.098414,2410.374 326.099414,2410.628 327.124414,2410.714 C327.435414,2408.985 328.383414,2407.409 329.848414,2406.323 C329.718414,2406.258 329.598414,2406.17 329.504414,2406.047 C329.167414,2405.609 329.250414,2404.981 329.688414,2404.645 C330.126414,2404.309 330.753414,2404.391 331.090414,2404.829 C331.245414,2405.032 331.302414,2405.275 331.285414,2405.511 C332.669414,2404.926 334.021414,2404.83 335.419414,2405.119 C336.081414,2403.016 335.837414,2400.846 334.854414,2399 C341.140414,2399.536 345.449414,2405.757 343.549414,2411.905 M330.274414,2402.427 C330.712414,2402.091 330.794414,2401.463 330.458414,2401.025 C330.121414,2400.587 329.494414,2400.504 329.056414,2400.841 C328.618414,2401.177 328.535414,2401.805 328.872414,2402.243 C329.208414,2402.681 329.836414,2402.764 330.274414,2402.427 M325.699414,2405.679 C325.363414,2405.241 325.445414,2404.614 325.883414,2404.277 C326.321414,2403.941 326.949414,2404.023 327.285414,2404.461 C327.622414,2404.899 327.539414,2405.527 327.101414,2405.863 C326.663414,2406.2 326.036414,2406.117 325.699414,2405.679" id="moon-[#1254]"></path> </g> </g> </g> </g></svg>`;
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/variable/Moon.astro", void 0);
...
const $$DarkMode = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a$1 || (_a$1 = __template$1(["", '<button id="themeToggle" class="inline-flex text-primary transition hover:scale-125 hover:opacity-70"> ', " ", ' </button> <script>\n  const getThemePreference = () => {\n    if (typeof localStorage !== "undefined" && localStorage.getItem("theme")) {\n      return localStorage.getItem("theme")\n    }}\n  //   return window.matchMedia("(prefers-color-scheme: dark)").matches\n  //     ? "light"\n  //     : "dark"\n  // }\n  const isDark = getThemePreference() === "dark"\n  document.documentElement.classList[isDark ? "add" : "remove"]("dark")\n\n  const handleToggleClick = () => {\n    const element = document.documentElement\n    element.classList.toggle("dark")\n\n    const isDark = element.classList.contains("dark")\n    localStorage.setItem("theme", isDark ? "dark" : "light")\n  }\n\n  document\n    .getElementById("themeToggle")\n    .addEventListener("click", handleToggleClick)\n\n<\/script>'])), maybeRenderHead(), renderComponent($$result, "SunIcon", $$Sun, { "class": "opacity-100 dark:opacity-0 size-7 transition text-white dark:text-[#012029]" }), renderComponent($$result, "MoonIcon", $$Moon, { "class": "dark:text-[#012029] transition text-white absolute opacity-0 dark:animate-fade-in dark:opacity-100 size-6" }));
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/components/DarkMode.astro", void 0);

const $$Astro$B = createAstro();
const $$Menu = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$B, $$props, $$slots);
  Astro2.self = $$Menu;
  return renderTemplate`${maybeRenderHead()}<svg${spreadAttributes(Astro2.props)} width="40" height="40" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"> <path d="M21 7 3 7" fill="#000" stroke="#dedede" stroke-linecap="round" stroke-linejoin="round" stroke-width="1"></path> <path d="M21 12 3 12" fill="#000" stroke="#dedede" stroke-linecap="round" stroke-linejoin="round" stroke-width="1"></path> <path d="M21 17 3 17" fill="#000" stroke="#dedede" stroke-linecap="round" stroke-linejoin="round" stroke-width="1"></path> </svg>`;
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/variable/Menu.astro", void 0);

const $$Astro$A = createAstro();
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$A, $$props, $$slots);
  Astro2.self = $$Header;
  return renderTemplate`${maybeRenderHead()}<div class="p-2 mb-2 text-xs md:text-lg text-[#012029] rounded-sm bg-blue-50 dark:bg-gray-800 dark:text-white text-center w-full mx-auto max-w-[1000px]" role="alert" data-astro-cid-3ef6ksr2> <span class="font-extrabold" data-astro-cid-3ef6ksr2>Página En Desarrollo.</span> Sigo realizando modificaciones.
</div> <header class="w-full mx-auto max-w-[1000px] md:py-12 h-[20vh] px-5 flex items-center justify-between md:block" data-astro-cid-3ef6ksr2> <div class="relative flex flex-row mx-auto justify-between items-center gap-10 w-full" data-astro-cid-3ef6ksr2> <a class="flex items-center text-center ancla-logo dark:hover:drop-shadow-[0_10px_20px_rgba(230,200,25,5)] cursor-pointer" data-astro-cid-3ef6ksr2> <img class="size-28 cover img-logo transition" loading="lazy" src="img/LogoNeider.avif" alt="" data-astro-cid-3ef6ksr2> <img class="size-24 cover img-logo-2 transition" loading="lazy" src="img/JavaScript-logo.avif" alt="Imagen del logo" data-astro-cid-3ef6ksr2> </a> <nav id="menu" class="md:justify-between md:gap-5 tracking-widest z-[99] text-4xl
    md:text-base absolute h-full top-0 left-0 right-0 bg-black py-[400px] md:py-0 md:static
    items-center justify-center md:bg-transparent md:ml-36 lg:ml-80
    hidden md:block flex flex-col md:flex-row gap-2 xl:gap-x-5 animate-jump-in
     lg:text-base text-[#CAA152] dark:bg-gradient-to-b dark:from-[#012029] dark:md:from-transparent bg-gradient-to-b from-[#e3e3e3] md:from-transparent opacity-90 fijada" data-astro-cid-3ef6ksr2> <ul class="flex flex-col md:flex-row justify-between items-center gap-10" data-astro-cid-3ef6ksr2> <a class="hover:text-[#fbc531] text-white dark:text-[#012029] font-black" href="/#proyectos" data-astro-cid-3ef6ksr2>Proyectos</a> <a class="hover:text-[#fbc531] text-white dark:text-[#012029] font-extrabold" href="/#habilidades" data-astro-cid-3ef6ksr2>Habilidades</a> <a class="hover:text-[#fbc531] text-white dark:text-[#012029] font-extrabold mb-2 md:mb-0" href="/#contacto" data-astro-cid-3ef6ksr2>Contacto</a> ${renderComponent($$result, "DarkMode", $$DarkMode, { "class": "dark:text-[#012029] text-[#012029]", "id": "dark", "data-astro-cid-3ef6ksr2": true })} </ul> </nav> </div> <button class="button z-[100]" data-astro-cid-3ef6ksr2> ${renderComponent($$result, "Menu", $$Menu, { "class": "text-white w-10 md:hidden block absolute top-[115px] right-10 bottom-0", "data-astro-cid-3ef6ksr2": true })} </button>   </header>`;
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/components/Header.astro", void 0);
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<html lang="en" class="md:mr-0"> <head><!-- Google tag (gtag.js)\n    <script async src="https://www.googletagmanager.com/gtag/js?id=G-RR7K6P0C5B"\n    ><\/script>\n    <script>\n      window.dataLayer = window.dataLayer || [];\n      function gtag() {\n        dataLayer.push(arguments);\n      }\n      gtag("js", new Date());\n\n      gtag("config", "G-RR7K6P0C5B");\n    <\/script> --><meta charset="UTF-8"><meta name="description"', '><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="img/LogoNeider.avif"><link rel="sitemap" href="/sitemap-index.xml"><title>', "</title>", '<!-- <link rel="stylesheet" href="path/to/atropos.css" /> -->', '</head> <body class="dark:bg-white"> ', " ", " ", "  </body> </html>"])), addAttribute(description, "content"), title, renderComponent($$result, "ViewTransitions", $$ViewTransitions, {}), renderHead(), renderComponent($$result, "Header", $$Header, {}), renderSlot($$result, $$slots["default"]), renderComponent($$result, "Footer", $$Footer, {}));
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/layouts/Layout.astro", void 0);

const $$Astro$y = createAstro();
const $$IconDownload = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$y, $$props, $$slots);
  Astro2.self = $$IconDownload;
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/variable/IconDownload.astro", void 0);
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/variable/Docs.astro", void 0);
...
const $$Container = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.props;
  return renderTemplate`${maybeRenderHead()}<section${addAttribute(`${Astro2.props.id}`, "id")}${addAttribute(`w-full mx-auto max-w-[1000px] mb-16 overflow-hidden px-8 ${Astro2.props.class} `, "class")}> ${renderSlot($$result, $$slots["default"])} </section>`;
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/components/Container.astro", void 0);

const $$Astro$v = createAstro();
const $$PersonalInformation = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$v, $$props, $$slots);
  Astro2.self = $$PersonalInformation;
...
<a href="#SeccionDeContacto" class="relative" data-astro-cid-tlnmwggr> <span class="md:absolute -top-[4px] hover:shadow-sm hover:shadow-yellow-200 font-extrabold py-1 px-2
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/components/PersonalInformation.astro", void 0);
...
function App$2() {
  ...
  return /* @__PURE__ */ jsx("div", { id: "app", children: /* @__PURE__ */ jsx(
    Atropos,
    {
      ...
      rotateXMax: 50,
      rotateYMax: 50,
      children: /* @__PURE__ */ jsxs("div", { class: "image", "data-atropos-offset": "5", children: [
        /* @__PURE__ */ jsx("img", { class: " rounded-2xl", src: "img/imagen.webp ", alt: "" }),
        /* @__PURE__ */ jsxs("div", { class: "absolute text-center flex flex-col text-xs md:text-xl items-center content-end bottom-0 p-1 md:p-10 mx-auto left-0 right-0 z-10 text-white", children: [
          /* @__PURE__ */ jsx("h2", { class: "text-xl md:text-3xl font-extrabold mb-5", children: "Ingeniero de Sistemas" }),
          /* @__PURE__ */ jsx("p", { class: "text-sm md:text-base font-extralight", children: '"Primero aprende informática y toda la teoría.' }),
          /* @__PURE__ */ jsx("p", { class: "text-sm md:text-base font-extralight", children: "Después desarrolla un estilo de programación." }),
          /* @__PURE__ */ jsx("p", { class: "text-sm md:text-base font-extralight", children: 'Entonces, olvídalo todo y hackea"' }),
          /* @__PURE__ */ jsx("em", { class: "text-sm my-3 md:my-5", children: '"George Carrette"' })
        ] })
      ] })
    }
  ) });
...
const $$Information = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="relative h-full border-orange-400 z-50 mb-10 rounded-lg" data-astro-cid-7magsbhs> ${renderComponent($$result, "Atropos", App$2, { "client:load": true, "client:component-hydration": "load", "client:component-path": "@/components/FeaturesFrameworks/Atropos.jsx", "client:component-export": "default", "data-astro-cid-7magsbhs": true })} <button id="openModal" class="my-2 flex items-center mx-auto group group-hover:before:duration-500 group-hover:after:duration-500 after:duration-500
              ...
              hover:duration-500 hover:after:-right-8 hover:before:right-12 hover:before:-bottom-8
               hover:before:blur origin-left border-[2px] border-slate-200 dark:border-slate-400 transition
                ...
                before:z-10 before:bg-red-700 before:rounded-md before:blur-lg after:absolute after:z-10 after:w-20 after:h-8
                 after:content[''] after:bg-yellow-400 after:right-8 after:top-1 after:rounded-full after:blur-lg" data-astro-cid-7magsbhs>
Sobre Mí...
</button> <div id="modal" class="modal-container" data-astro-cid-7magsbhs> <div class="modal-content" data-astro-cid-7magsbhs> <h1 data-astro-cid-7magsbhs>Holaaaaaaaaaaaa a todos</h1> <p data-astro-cid-7magsbhs>lajdnksdjnksjdfhskjdfhskdfjsfdkshddksfhkfdsfkjdfjksdfsdfhsdshf</p> <div id="closeModal" class="close" data-astro-cid-7magsbhs> <p data-astro-cid-7magsbhs>Salir</p> </div> </div> </div> </section> `;
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/components/Information.astro", void 0);
...
const $$GitHub = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$GitHub;
  return renderTemplate`${maybeRenderHead()}<svg${spreadAttributes(Astro2.props)} viewBox="0 0 256 250" width="256" height="250" fill="currentColor" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid"><path d="M128.001 0C57.317 0 0 57.307 0 128.001c0 56.554 36.676 104.535 87.535 121.46 6.397 1.185 8.746-2.777 8.746-6.158 0-3.052-.12-13.135-.174-23.83-35.61 7.742-43.124-15.103-43.124-15.103-5.823-14.795-14.213-18.73-14.213-18.73-11.613-7.944.876-7.78.876-7.78 12.853.902 19.621 13.19 19.621 13.19 11.417 19.568 29.945 13.911 37.249 10.64 1.149-8.272 4.466-13.92 8.127-17.116-28.431-3.236-58.318-14.212-58.318-63.258 0-13.975 5-25.394 13.188-34.358-1.329-3.224-5.71-16.242 1.24-33.874 0 0 10.749-3.44 35.21 13.121 10.21-2.836 21.16-4.258 32.038-4.307 10.878.049 21.837 1.47 32.066 4.307 24.431-16.56 35.165-13.12 35.165-13.12 6.967 17.63 2.584 30.65 1.255 33.873 8.207 8.964 13.173 20.383 13.173 34.358 0 49.163-29.944 59.988-58.447 63.157 4.591 3.972 8.682 11.762 8.682 23.704 0 17.126-.148 30.91-.148 35.126 0 3.407 2.304 7.398 8.792 6.14C219.37 232.5 256 184.537 256 128.002 256 57.307 198.691 0 128.001 0Zm-80.06 182.34c-.282.636-1.283.827-2.194.39-.929-.417-1.45-1.284-1.15-1.922.276-.655 1.279-.838 2.205-.399.93.418 1.46 1.293 1.139 1.931Zm6.296 5.618c-.61.566-1.804.303-2.614-.591-.837-.892-.994-2.086-.375-2.66.63-.566 1.787-.301 2.626.591.838.903 1 2.088.363 2.66Zm4.32 7.188c-.785.545-2.067.034-2.86-1.104-.784-1.138-.784-2.503.017-3.05.795-.547 2.058-.055 2.861 1.075.782 1.157.782 2.522-.019 3.08Zm7.304 8.325c-.701.774-2.196.566-3.29-.49-1.119-1.032-1.43-2.496-.726-3.27.71-.776 2.213-.558 3.315.49 1.11 1.03 1.45 2.505.701 3.27Zm9.442 2.81c-.31 1.003-1.75 1.459-3.199 1.033-1.448-.439-2.395-1.613-2.103-2.626.301-1.01 1.747-1.484 3.207-1.028 1.446.436 2.396 1.602 2.095 2.622Zm10.744 1.193c.036 1.055-1.193 1.93-2.715 1.95-1.53.034-2.769-.82-2.786-1.86 0-1.065 1.202-1.932 2.733-1.958 1.522-.03 2.768.818 2.768 1.868Zm10.555-.405c.182 1.03-.875 2.088-2.387 2.37-1.485.271-2.861-.365-3.05-1.386-.184-1.056.893-2.114 2.376-2.387 1.514-.263 2.868.356 3.061 1.403Z" fill="#000"></path></svg>`;
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/GitHub.astro", void 0);

const $$Astro$s = createAstro();
const $$Chrome = createComponent(async ($$result, $$props, $$slots) => {
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/Chrome.astro", void 0);
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/Html.astro", void 0);
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/Css.astro", void 0);
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/React.astro", void 0);
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/Javascript.astro", void 0);
...
const PROJECTS = [
  {
    ...
    page: "https://www.abogadasandraalba.com/"
  },
  {
    url: "/img/artex.avif",
    title: "Page ArtexAlex",
    technologies: [
      TECNOLOGYS.HTML,
      TECNOLOGYS.CSS,
      TECNOLOGYS.ASTRO,
  ...
  },
  {
    url: "/img/bar.avif",
    title: "Page Bar",
    technologies: [TECNOLOGYS.HTML, TECNOLOGYS.CSS, TECNOLOGYS.JAVASCRIPT],
...
const $$Projects = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="grids mt-5" data-astro-cid-amng4zvp> ${PROJECTS.map((project) => renderTemplate`<article class="relative before:absolute before:rounded-lg before:content before:bg-[var(--lineTop)] before:h-[5px] before:top-0 before:left-0 before:right-0 before:z-10
      after:absolute after:rounded-lg after:content after:bg-sky-500 after:h-[5px] after:bottom-0 after:left-0 after:right-0 after:z-50
       bg-[#D3D3D3] text-[#1d2029] overflow-hidden rounded-lg" data-astro-cid-amng4zvp> <div class="overflow-hidden hover:bg-gradient-to-b from-black" data-astro-cid-amng4zvp> <img class="h-44 w-full hover:scale-125 transition ease-in-out hover:animate-pulse object-center"${addAttribute(project.url, "src")}${addAttribute(`Imagen de ${project.title}`, "alt")} data-astro-cid-amng4zvp> </div> <div class="flex flex-col items-center text-balance p-5" data-astro-cid-amng4zvp> <h3 class="text-2xl font-black" data-astro-cid-amng4zvp>${project.title}</h3> <span class="flex justify-between items-center gap-3 mt-3" data-astro-cid-amng4zvp>${project.technologies.map((tecnology) => renderTemplate`<span${addAttribute(`flex flex-col justify-center items-center font-extrabold ${tecnology.class}`, "class")} data-astro-cid-amng4zvp> ${renderComponent($$result, "tecnology.icon", tecnology.icon, { "class": "size-5 hover:scale-125 transition cursor-crosshair icon", "data-astro-cid-amng4zvp": true })} </span>`)} </span> <p class="mt-3 text-justify text-sm font-extralight" data-astro-cid-amng4zvp>${project.text}</p> </div> <footer class="flex flex-row justify-evenly gap-5 mb-5" data-astro-cid-amng4zvp> <a${addAttribute(project.gh, "href")} target="_blank" data-astro-cid-amng4zvp> ${renderComponent($$result, "GitHub", $$GitHub, { "class": "h size-8 hover:scale-125 hover:filter hover:drop-shadow-lg transition cursor-pointer", "data-astro-cid-amng4zvp": true })} </a> <a${addAttribute(project.page, "href")} target="_blank" data-astro-cid-amng4zvp> ${renderComponent($$result, "Chrome", $$Chrome, { "class": "h size-8 hover:scale-110 hover:filter hover:drop-shadow-lg hover:from-red-500 transition cursor-pointer ", "data-astro-cid-amng4zvp": true })} </a> </footer> </article>`)} </section> `;
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/components/Projects.astro", void 0);
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/Bootstrap.astro", void 0);

const $$Astro$j = createAstro();
const $$Sass = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$j, $$props, $$slots);
  Astro2.self = $$Sass;
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/Sass.astro", void 0);
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/Typescript.astro", void 0);
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/NextJs.astro", void 0);

const $$Astro$g = createAstro();
const $$NodeJs = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$g, $$props, $$slots);
  Astro2.self = $$NodeJs;
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/NodeJs.astro", void 0);
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/Git.astro", void 0);
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/Sql.astro", void 0);
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/Python.astro", void 0);

const $$Astro$c = createAstro();
const $$Bun = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$c, $$props, $$slots);
  Astro2.self = $$Bun;
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/Bun.astro", void 0);

const $$Astro$b = createAstro();
const $$Pnpm = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$b, $$props, $$slots);
  Astro2.self = $$Pnpm;
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/Pnpm.astro", void 0);

const $$Astro$a = createAstro();
const $$Notion = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$a, $$props, $$slots);
  Astro2.self = $$Notion;
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/Notion.astro", void 0);

const $$Astro$9 = createAstro();
const $$ViteJs = createComponent(async ($$result, $$props, $$slots) => {
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/ViteJs.astro", void 0);
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/Linux.astro", void 0);
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/MarkDown.astro", void 0);
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/Wordpress.astro", void 0);

const $$Astro$5 = createAstro();
const $$Php1 = createComponent(async ($$result, $$props, $$slots) => {
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/Php1.astro", void 0);

const $$Astro$4 = createAstro();
const $$Vercel = createComponent(async ($$result, $$props, $$slots) => {
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/icons/Vercel.astro", void 0);
...
const $$Tecnologys = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$3, $$props, $$slots);
  Astro2.self = $$Tecnologys;
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/components/Tecnologys.astro", void 0);
...
function ContactForm() {
  ...
  return /* @__PURE__ */ jsxs(
    "form",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { class: "grid gap-6 mb-6 md:grid-cols-1", children: /* @__PURE__ */ jsxs("div", { class: "relative z-0", children: [
          /* @__PURE__ */ jsx(
            "input",
            {
              name: "names",
        ...
        /* @__PURE__ */ jsxs("div", { class: "grid gap-6 mb-6 md:grid-cols-1", children: [
          /* @__PURE__ */ jsx("h2", { class: "font-extrabold text-center", children: "¿TE GUSTÓ EL PORTAFOLIO?" }),
          /* @__PURE__ */ jsxs("div", { class: "flex justify-center gap-10 py-0", children: [
            /* @__PURE__ */ jsx(
              "label",
              {
...
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/components/Contact.astro", void 0);
...
const $$Experience = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="container mx-auto w-full h-full"> <div class="relative wrap overflow-hidden p-10 h-full"> <div class="border-2-2 absolute border-opacity-20 border-gray-700 h-full border" style="left: 50%"></div> <!-- right timeline --> ${WORKS.map(
    (work) => work.direction == "right" ? renderTemplate`<div class="mb-8 flex justify-between items-center w-full right-timeline hover:scale-105 transition"> <div class="order-1 w-5/12"></div> <div class="z-20 flex items-center order-1 bg-gray-800 shadow-xl w-8 h-8 rounded-full"> <h1 class="mx-auto font-semibold text-lg text-white"> ${work.id} </h1> </div> <div class="order-1 bg-gray-400 rounded-lg shadow-xl w-5/12 px-6 py-4"> <h1 class="mx-auto font-extrabold text-xl text-white"> ${work.title} </h1> <h3 class="mb-3 font-bold text-white text-sm inline"> ${work.subtitle}${" "} </h3> <span class="mx-2">|</span> <span class="mx-auto font-semibold text-xs text-white"> ${work.date} </span> <ul class="list-disc"> <li> <p class="mt-2 text-xs font-extralight text-white"> ${work.text} </p> </li> <li> <p class="text-xs font-extralight text-white">${work.text2}</p> </li> </ul> </div> </div>` : renderTemplate`<div class="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline hover:scale-105 transition"> <div class="order-1 w-5/12"></div> <div class="z-20 flex items-center order-1 bg-gray-800 shadow-xl w-8 h-8 rounded-full"> <h1 class="mx-auto text-white font-semibold text-xl"> ${work.id} </h1> </div> <div class="order-1 bg-red-400 rounded-lg shadow-xl w-5/12 px-6 py-4"> <h1 class="mx-auto text-white font-semibold text-xl"> ${work.title} </h1> <h3 class="mb-3 font-bold text-white text-sm inline"> ${work.subtitle} </h3> <span class="mx-2">|</span> <span class="mx-auto font-semibold text-xs text-white"> ${work.date} </span> <ul class="list-disc"> <li> <p class="mt-2 text-xs font-extralight text-white"> ${work.text} </p> </li> <li> <p class="text-xs font-extralight text-white">${work.text2}</p> </li> </ul> </div> </div>`
  )} </div> </div>`;
}, "C:/Users/neider_nieto/Desktop/Web/portfolio Neider/src/components/Experience.astro", void 0);
